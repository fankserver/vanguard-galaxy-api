...
try {
    ...
    $record = @{ creationEvidenceSha256=''; timeoutSeconds=600; preservationRoots=@('C:\fixture\plugins','C:\fixture\config','C:\fixture\saves'); process=$description; schema='world-empty-run-v1'; root=$root; gameDirectory=$source; runId=$run.ToString('D'); phase='create'; reviewedHead=$head; authorizationSha256=$observed.authorizationSha256;
