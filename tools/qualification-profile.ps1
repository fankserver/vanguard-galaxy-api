...
function Assert-QualificationUnused([string]$Root) {
    foreach ($name in @('result.txt','process.json','run-started.txt','playerprefs-before.reg','vanilla-load-control.txt','vanilla-orbit-failure.txt','persistence-probe.txt','journal-coordinated.txt','stockpile-coordinated.txt','content-reference.txt','mission-transitions.txt','mission-events.tsv','mission-clear.txt','mission-guild.txt','mission-waves.txt','mission-wave-events.tsv','mission-identity.txt','journal-mission-events.txt','anima-missions.txt','anima-mission-events.tsv','travel-station.txt','travel-station-receipt.tsv','travel-station-events.tsv','travel-cross-system.txt','travel-cross-system-receipt.tsv','travel-cross-system-events.tsv','travel-cross-system-fault.txt','travel-resilience.txt','travel-resilience-receipt.tsv','travel-resilience-events.tsv','travel-resilience-fault.txt','travel-recovery.txt','travel-recovery-receipt.tsv','travel-recovery-events.tsv','travel-recovery-fault.txt','travel-fast-lane.txt','travel-fast-lane-receipt.tsv','travel-fast-lane-events.tsv','travel-fast-lane-fault.txt','anima-travel.txt','anima-travel-receipt.tsv','anima-travel-events.tsv','anima-travel-fault.txt','echo-travel.txt','echo-travel-receipt.tsv','echo-travel-events.tsv','echo-travel-fault.txt','echo-absent.txt','travel-journal.txt','travel-journal-receipt.tsv','travel-journal-events.tsv','travel-journal-fault.txt','travel-journal-postquit-audit.txt','run-outcome.json')) {
