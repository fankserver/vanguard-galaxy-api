...
if ($Action -eq 'Prepare') {
    ...
    if ($ForgeReadProbe) {
        $otherSwitches = @($PSBoundParameters.Keys | Where-Object { $PSBoundParameters[$_] -is [Management.Automation.SwitchParameter] -and $PSBoundParameters[$_].IsPresent -and $_ -notin @('ForgeReadProbe','ForgeCommandProbe','ForgePersistenceProbe','ForgeDeliveryProbe','RefineryProbe','Diagnostics') })
