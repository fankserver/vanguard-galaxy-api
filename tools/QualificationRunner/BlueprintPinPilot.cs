...
public sealed partial class Plugin
{
    private IEnumerable<object?> CheckBlueprintPin()
    {
        ...
        try
        {
            ...
            foreach (var frame in CheckGeneratedForgeDelivery()) yield return frame;
            foreach (var frame in CheckForgeMissingContext()) yield return frame;
            WriteAtomic("blueprint-pin.txt", new[] { "PASS", "blueprint-pin-v11", "pin-batch-exact-variant-navigation-close-producer-routes-queue-partial-cancel-multiunit-reload-saveas-switch-inspector-isolation-context-generated-routing-bonus-fullcargo" });
