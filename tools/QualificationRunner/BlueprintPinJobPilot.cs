    ...
    private IEnumerable<object?> CheckPinJobs(Mouse mouse)
    {
        ...
        try
        {
            ...
            foreach (var candidate in candidates)
            {
                ...
                // Leave two craftable batches after delivery for the final Pin action and callback phase.
                if (slider == null || slider.minValue > 2 || slider.maxValue < 4) { discovery.Add("reject=sliderRange"); continue; }
                slider.value = 2;
