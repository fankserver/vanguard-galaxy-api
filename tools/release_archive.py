...
FILES = {
    ...
    *('docs/' + name + '.md' for name in (
        ...
        'qualification-runner', 'research-findings', 'persistence-identity', 'persistence-schema', 'persistence-storage', 'content-safety', 'mission-events', 'travel-events', 'story-content', 'mod-information', 'mod-update-publishing')),
}
