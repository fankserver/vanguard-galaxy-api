...
| Recipe catalog | Optional default-off immutable Forge/refining definitions and producer lookup at the current station | Host/reflection and installed-binding tests only; no Unity recipe acceptance, contextual quote or mutation capability |
