...
| Recipes and requirements | Optional default-off Forge/refining definitions, producer lookup and issued-station advisory quotes | Host/reflection and installed-binding tests only; no Unity recipe acceptance or mutation capability |
