...
- Do not mutate the in-progress vanilla load/save operation from an observational callback. For installation gameplay reactions, use [object-scoped installation events](dungeon.md#installation-reactions), whose handlers run at a safe action boundary.
