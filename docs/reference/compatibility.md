...
| Recipes and jobs | Optional default-off definitions, quotes and job/transfer observations; guarded commands require an additional opt-in | Host/reflection and installed-binding tests only; complete Unity crafting acceptance remains pending |
