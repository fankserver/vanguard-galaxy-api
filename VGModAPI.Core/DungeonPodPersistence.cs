...
internal sealed class DungeonPodPersistence : IDisposable
{
    ...
    internal TerminalAttempt? BeginTerminal(Guid id)
    {
        ...
        var attempted = new DungeonOperationResumeState(operation.Id, operation.LocationId, operation.DungeonId, operation.AttackerShipId,
    ...
    internal sealed class TerminalAttempt : IDisposable
    {
        ...
        internal void Completed()
        {
            ...
            _owner._operations.Track(new(_attempted.Id, _attempted.LocationId, _attempted.DungeonId, _attempted.AttackerShipId, _attempted.DungeonType,
