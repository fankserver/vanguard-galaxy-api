...
internal sealed class AuthoredWormholePairOccurrence
{
    ...
    internal AuthoredWormholePairOccurrence(string owner, string localId, string occurrenceKey, int revision,
