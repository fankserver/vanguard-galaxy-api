...
internal sealed class PocketSystemDeclaration
{
    ...
    /// <summary>Makes the authored system silent: no decorative traffic and no security patrols in it.</summary>
    ...
    internal PocketSystemDeclaration(string localId, int revision, string name, PocketSystemPlacement placement = PocketSystemPlacement.OffMap, string? factionId = null, string? sectorName = null, bool quiet = false)
    {
        ...
        LocalId = localId; Revision = revision; Name = name; Placement = placement; FactionId = factionId; SectorName = sectorName; Quiet = quiet;
    }
}
