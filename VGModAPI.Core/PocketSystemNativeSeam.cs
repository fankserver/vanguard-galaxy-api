...
internal sealed class PocketSystemInfo
{
    internal string SystemId { get; }
    internal string EntranceGateId { get; }
    internal string PocketGateId { get; }
    internal PocketSystemInfo(string systemId, string entranceGateId, string pocketGateId)
...
internal interface IPocketSystemNative
{
    ...
    RemovalStatus Readiness(Guid session, string systemId, string entranceGateId, string pocketGateId);
