...
internal sealed class WormholePairPoi
{
    ...
    internal WormholePairPoi(string owner, string localId, string poiKey, int revision,
        string firstSystemId, string secondSystemId, string firstPoiId, string secondPoiId, bool declaredOpen)
    {
        ...
        if (string.IsNullOrWhiteSpace(poiKey) || WorldStateCodec.TextByteCount(poiKey) > 256) throw new ArgumentException(nameof(poiKey));
