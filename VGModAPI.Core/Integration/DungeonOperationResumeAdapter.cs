...
internal sealed class DungeonOperationResumeAdapter
{
    ...
    internal bool Resumed(object operation)
    {
        ...
        if (saved == null || saved.Retired || _conflicts.Contains(saved.Id) || (saved.TerminalProgress != DungeonTerminalProgress.NotStarted && !saved.MayResumeWalkExtraction)) return false;
