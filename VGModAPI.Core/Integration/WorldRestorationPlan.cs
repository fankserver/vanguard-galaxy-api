...
{
    internal WorldSnapshotInstance[] Pois { get; }
    private readonly Action? _apply, _rollback;
    internal WorldRestorationPlan(WorldSnapshotInstance[] pois, Action? apply = null, Action? rollback = null)
    { Pois = pois; _apply = apply; _rollback = rollback; }
