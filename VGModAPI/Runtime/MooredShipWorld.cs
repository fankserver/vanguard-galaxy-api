...
/// </summary>
internal sealed class MooredShipWorld : IMooredShipNative
{
    ...
    internal MooredShipWorld(GameAdapter game, Assembly assembly, Action<Exception>? report = null)
    {
    ...
    private void ApplyIdentity(object shipData, MooredShipDeclaration declaration)
    {
    ...
    private object Offset(object station, MooredShipDeclaration declaration)
    {
