...
internal sealed class DungeonPanelRuntime : IDungeonPanelSource, IDisposable
{
    ...
    private readonly IBoardingEvents _boarding;
    ...
    internal DungeonPanelRuntime(GameBindings game, BoardingObserver observer, IBoardingEvents boarding, Func<object?, bool> ready)
    {
