...
internal sealed class DungeonPanelRuntime : IDungeonPanelSource, IDisposable
{
    ...
    private readonly BoardingService _boarding;
    ...
    internal DungeonPanelRuntime(GameBindings game, BoardingObserver observer, BoardingService boarding, Func<object?, bool> ready)
    {
