...
public sealed partial class Plugin
{
    ...
    private void PublishServiceRoot()
    {
        ...
        var root = new ModServices(lifecycle, mods, new SaveDataServiceView(hub, _persistence), missions, travel, station);
        // Deferred cleanup preserves terminal lifecycle delivery when shutdown starts inside a callback.
        foreach (var view in new IDisposable[] { lifecycle, mods, missions, travel, station })
