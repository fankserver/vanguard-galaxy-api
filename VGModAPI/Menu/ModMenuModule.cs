...
internal sealed class ModMenuModule : IDisposable
{
    ...
    internal ModMenuModule(Assembly assembly, ModInformationCatalog catalog, ModSettingsService settings,
        Action<Exception> fault, ModUpdatePresenter? updates = null)
    {
        ...
        _lifetime = new ModMenuLifetime((menu, viewport, canvas) => ModMenuView.Create(
            ...
            new ModInformationPresenter(catalog), settings, fault, updates));
    }
