        ...
        try
        {
            ...
            WorldLoadHookInstallation.Install(
                () =>
                {
                    ...
                    foreach (var key in new[] { "worldGenerate", "worldRegenerateAsteroids", "worldRebuildStation", "worldJumpgateWave", "worldDeferGeneration", "worldPoiAddPersistable", "worldPoiRemovePersistable", "worldPoiAddUnit", "worldPoiRemoveUnit" })
