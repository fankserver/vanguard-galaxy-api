        ...
        try
        {
            ...
            WorldLoadHookInstallation.Install(
                () =>
                {
                    ...
                    _worldLoadHarmony.Patch(targets["worldGenerate"], prefix: new HarmonyMethod(typeof(WorldLifetimePatches.Generate).GetMethod("Prefix", BindingFlags.NonPublic | BindingFlags.Static)) { priority = Priority.First });
