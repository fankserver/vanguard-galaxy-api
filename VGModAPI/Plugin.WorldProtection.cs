        ...
        try
        {
            ...
            WorldLoadHookInstallation.Install(
                () =>
                {
                    ...
                    foreach (var key in new[] { "worldBaseArrival", "worldCombatArrival", "worldManagerStart", "worldManagerUpdate", "worldSecurityPatrol" })
