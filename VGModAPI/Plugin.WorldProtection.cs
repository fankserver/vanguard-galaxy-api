        ...
        try
        {
            ...
            WorldLoadHookInstallation.Install(
                () =>
                {
                    ...
                    foreach (var key in new[] { "worldActorStart", "worldActorUpdate", "worldActorPhysics", "worldShipStart", "worldShipUpdate" })
