        ...
        try
        {
            ...
            WorldLoadHookInstallation.Install(
                () =>
                {
                    ...
                    _worldLoadHarmony.Patch(targets["worldGenerate"], prefix: new HarmonyMethod(typeof(WorldLifetimePatches.Generation).GetMethod("Prefix", BindingFlags.NonPublic | BindingFlags.Static)) { priority = Priority.First },
                    ...
                    _worldLoadHarmony.Patch(targets["worldRegenerateSalvage"], prefix: new HarmonyMethod(typeof(WorldLifetimePatches.Generation).GetMethod("StaticPrefix", BindingFlags.NonPublic | BindingFlags.Static)) { priority = Priority.First },
                        finalizer: new HarmonyMethod(typeof(WorldLifetimePatches.Generation).GetMethod("Finalizer", BindingFlags.NonPublic | BindingFlags.Static)) { priority = Priority.Last });
