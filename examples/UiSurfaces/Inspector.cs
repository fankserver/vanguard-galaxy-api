...
/// <summary>
/// A Forge inspector built from public contracts only. This file deliberately touches **no Unity or
/// BepInEx type**, so it can be lifted straight into a non-Unity assembly; the repository host tests
/// compile exactly this file without BepInEx to keep that property honest. The plugin in this same
/// package owns and disposes this main-thread registration scope.
/// </summary>
