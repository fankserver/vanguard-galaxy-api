...
| **[TractorGuide](TractorGuide/)** | **One autopilot decision without patches** — a settings-gated extra tractor beam for the autopilot; abstain-by-null, native safety retained. Requires the matching development API, not public 0.2.8. | `Equipment` |
