...
internal static class PackageChecks
{
    ...
    internal static readonly string[] Documents =
    {
        ...
        "qualification-runner.md", "research-findings.md", "persistence-identity.md", "persistence-schema.md", "persistence-storage.md", "content-safety.md", "mission-events.md", "travel-events.md", "story-content.md"
    };
