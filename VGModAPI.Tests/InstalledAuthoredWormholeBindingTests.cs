...
public sealed class InstalledAuthoredWormholeBindingTests
{
    [Fact]
    public void NativeWormholePairMembersBindToInspectedShapes()
    {
        ...
        foreach (var spec in AuthoredWormholePairBindings.Members)
        {
        ...
        foreach (var spec in AuthoredWormholePairBindings.Methods)
        {
        ...
        var wormhole = assembly.MainModule.GetType(AuthoredWormholePairBindings.Wormhole);
