...
/// system, + anchor-side entrance jump gate, + pocket-side jump gate) and verifies WorldNativeAuthored's
...
/// </summary>
public sealed class AuthoredSystemDeltaTests
{
    ...
    private static bool Exact(SystemMapData created, SystemMapData anchor,
        ...
        => WorldNativeAuthored.VerifyPocketDelta(before, after, created, anchor,
