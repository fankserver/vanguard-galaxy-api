...
internal sealed class FakeAuthoredNative : IAuthoredSystemNative
{
    ...
    public AuthoredSystemPocketInfo? CreatePocket(Guid session, string anchorSystemId)
    {
        ...
        Open[sid] = false;
        return new AuthoredSystemPocketInfo(sid, "en-" + NextId, "pk-" + NextId);
    }
    public AuthoredSystemPocketInfo? ResolvePocket(Guid session, string systemId)
    {
        ...
        return new AuthoredSystemPocketInfo(systemId, pair.Entrance, pair.Pocket);
    }
