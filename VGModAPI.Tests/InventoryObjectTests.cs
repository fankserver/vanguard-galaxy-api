...
public sealed class InventoryObjectTests
{
    ...
    private sealed class Fixture : IDisposable
    {
        ...
        internal Fixture()
        {
            ...
            Games = new GameService(Hub, new NavigationService(Hub, _ => null, (_, _, _) => NavigationStatus.Unavailable, (_, _) => null), Engine, new StoryContentService(Hub.Services, null, Hub, (_, _) => null), new BarContentService(null, Hub, (_, _) => null, _ => false, Hub.CheckThread));
            Start();
        }
