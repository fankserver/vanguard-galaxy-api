...
public sealed class CargoEncounterPanelTests
{
    ...
    public void ActionChecksEligibilityReportsConflictAndReleasesAcquiredControl(bool admitted, bool failTactic)
    {
        ...
        using var example = new CargoEncounterPanel("cargo", target, dungeons, value => result = value, _ => { });
    ...
    public void SettlementDoesNotDependOnPanelPresentationAndFailureReleasesSubscriptions(bool failRegistration)
    {
        ...
        CargoEncounterPanel Create() => new("cargo", target, dungeons, _ => throw new InvalidOperationException("Unexpected command receipt"), _ => observed++);
