...
public sealed class GameServiceTests
{
    ...
    public void StartedCarriesAnActionableGameAndCapturedNavigationCannotActInReplacementSave()
    {
        ...
        using var games = new GameService(hub, navigation, new InventoryService(hub, () => null), new StoryMissionService(hub.Services, null, hub, (_, _) => null), new BarService(null, hub, (_, _) => null, _ => false, hub.CheckThread));
